...
public class Labyrint {
    ...
    public void resetRutenett() {
        for (int y = 0; y < hoyde(); y++) {
            for (int x = 0; x < bredde(); x++) {
                Rute rute = rutenett[y][x];
                rute.resetRute();
                rute.resetTraadFarge();
            }
        }
    }
    ...
    public List<String> finnStringUtveiFra(int startX, int startY) {
    ...
    public List<List<Rute>> finnUtveiFra(int startX, int startY) {
